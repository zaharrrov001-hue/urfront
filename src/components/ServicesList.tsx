          ...
          {services.map((service) => (
            ...
            >
              <CardHeader className="pb-4">
                <div className="hidden md:block mb-4 w-14 h-14 lg:w-16 lg:h-16 p-3 lg:p-3.5 rounded-sm bg-[#1a2a4a] group-hover:bg-[#d4a853] transition-colors duration-300 text-[#d4a853] group-hover:text-[#1a2a4a]">
                  {service.icon}
                </div>
